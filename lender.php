          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              ...
              <div class="row">
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                        <label  class="custom-control custom-checkbox" for="ledningtype"> Lending Type </label>     
                          <fieldset class="group"> 
                            <ul class="checkbox"> 
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                        <label  class="custom-control custom-checkbox" for="borrowertype"> Borrower Type </label>     
                          <fieldset class="group"> 
                            <ul class="checkbox"> 
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                          <label class="text-inverse" for="lendertype">Loan Amount</label>
                          <select class="custom-select d-block form-control" id="lendertype" required>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                          <label class="text-inverse" for="lendingterms">Lending Terms</label>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                          <label class="text-inverse" for="interestrate">Interest Rate</label>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                          <label class="text-inverse" for="lendingfees">Lending Fees</label>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                          <label class="text-inverse" for="depositreq">Deposit Requirements</label>
                ...
                <label class="text-inverse" for="depositreq">Geographic Boundaries</label>
                </div>
                <div class="form-group col-md-2">
                   ...
                   <div class="checkbox">               
                    ...
                    <div class="checkbox">               
                      <label for="South" style="margin-bottom:20px; margin-top:10px;"><input id="South" type="checkbox"/>South</label>
                    </div>
                  ...
                  <div class="form-group col-md-2">
                        ...
                        <div class="checkbox">               
                          <label for="West" style="margin-bottom:20px; margin-top:10px;"><input id="West" type="checkbox"/>West</label>
                        </div>
                </div>
                <div class="form-group col-md-3">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <label  class="custom-control custom-checkbox" for="docreq"> Documens Requirements</label>     
                          <fieldset class="group"> 
                            <ul class="checkbox"> 
